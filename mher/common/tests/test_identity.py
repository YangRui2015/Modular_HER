import pytest
from mher.common.tests.envs.identity_env import DiscreteIdentityEnv, BoxIdentityEnv, MultiDiscreteIdentityEnv
from mher.run import get_learn_function
from mher.common.tests.util import simple_test
from mher.common.tests import mark_slow
